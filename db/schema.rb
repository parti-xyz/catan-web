...
ActiveRecord::Schema.define(version: 20160718073547) do
  ...
  add_index "articles", ["link_source_id"], name: "index_articles_on_link_source_id", using: :btree
  add_index "articles", ["post_issue_id", "link_source_id", "active"], name: "index_articles_on_unique_link_source", unique: true, using: :btree
  ...
  add_index "issues", ["slug", "active"], name: "index_issues_on_slug_and_active", unique: true, using: :btree
  add_index "issues", ["title", "active"], name: "index_issues_on_title_and_active", unique: true, using: :btree
