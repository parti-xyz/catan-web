(function() {
  ...
  var scrollFrame = function(el) {
    ...
    el.addEventListener('click', function(e) {
      ...
      var aTag = closest(e.target, 'a');
      var href = aTag && aTag.getAttribute('href');
      if (href && href != '#') {
        return true;
      }
      var disabled = closest(e.target, '[data-disable-modal="true"]')
      if (disabled.length) {
        return true;
      }

      e.preventDefault();
      openIframe(el.getAttribute('data-url'));

      return false;
    });
  }

  var originalScrollFrame = function(selector) {
    refreshOnNewIframePage();
  ...
  var firstRefreshedOnNewIframePage;
  var refreshOnNewIframePage = function() {
    addEventListener('message', function(e) {
      if (firstRefreshedOnNewIframePage) return;
      ...
      firstRefreshedOnNewIframePage = true;
    });
  }
