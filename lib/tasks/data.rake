namespace :data do
  ...
  task 'seed:group' => :environment do
    ...
    Group.transaction do
      group = Group.find_or_initialize_by slug: 'gwangju'
      ...
      group = Group.find_or_initialize_by slug: 'do'
      group.assign_attributes(
        user: user,
        name: '나는 알아야겠당',
      ...
      group = Group.find_or_initialize_by slug: 'duckup'
      group.assign_attributes(
        user: user,
        name: '덕업넷',
        site_title: '덕후들 모여라',
      ...
      group = Group.find_or_initialize_by slug: 'change'
      group.assign_attributes(
        user: user,
        name: '바꿈',
      ...
      group = Group.find_or_initialize_by slug: 'toktok'
      group.assign_attributes(
        user: user,
        name: '국회톡톡',
      ...
      group = Group.find_or_initialize_by slug: 'innovators'
      group.assign_attributes(
        user: user,
        name: 'N명의 사회혁신가',
      ...
      group = Group.find_or_initialize_by slug: 'slowalk'
      group.assign_attributes(
        user: user,
        name: '슬로워크',
