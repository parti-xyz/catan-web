  ...
  def index
    if current_group.blank?
      if params[:keyword].present?
        ...
        @groups = Group.not_private_blocked(current_user).hottest.sort_by_name.where(slug: Issue.alive.deprecated_not_private_blocked(current_user).select(:group_slug))
